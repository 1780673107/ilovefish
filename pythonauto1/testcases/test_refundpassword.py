...
@ddt
class ReFundPasswordTestCase(unittest.TestCase):
    """重置资金密码"""
    excel = ReadExcel(data_file_path, 'refundpassword')
    ...
    def setUp(self):
        ...
        self.response_text = self.refund_password_code()
    def refund_password_code(self):
        url='http://13.215.67.65:8801/uc/verify/sms/reset_transaction_pwd'
