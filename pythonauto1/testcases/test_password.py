...
from common.regis import send_sms_verification_code,random_phone,generate_random_username,register_user
...
class PassWordTestCase(unittest.TestCase):
    """修改资金密码"""
    excel = ReadExcel(data_file_path, 'password')
    ...
    def setUp(self):
        ...
        print(self.token)
        self.response_text = self.password_code()
        
    def password_code(self):
        url='http://13.215.67.65:8801/uc/mobile/update/password/code'
    ...
    @data(*cases)
    def test_case_password(self, case):
        # 登录接口用例执行的逻辑
        # 第一步：准备测试用例数据
